...
function IndexPopupQuery() {
  console.log("clicked")
  event.preventDefault()
  let name = document.getElementById("popup_name").value
  let email = document.getElementById("popup_email").value
  let mobile = document.getElementById("popup_mobile").value
  let date = document.getElementById("popup_date").value


  console.log(name, email, mobile, date)
  ...
  //     "location":location
  // })
  var body = "Name: " + name + "<br/><br/>Email: " + email + "<br/><br/> Mobile: " + mobile + "<br/><br/> Date & Time: " + date
  ...
  Email.send({
    ...
    To: 'shivashakti433@gmail.com',
    From: "shivashakti433@gmail.com",
